...
const UsersList: React.FC = () => {
    ...
    const { filter, loading, error, filteredData } = useSelector((state: { users: AppState }) => state.users)
            ...
            <div className={styles.usersList}>
                {filteredData.map((user) => (
                    ...
                    >
                        ...
                        <div className={styles.removeButton} onClick={() => handleRemoveUser(user.id)}>&times;</div>
                    </div>
                ))}
            </div>
